	...
	public boolean interact(Char c) {
		...
		if (Quest.given) {
			...
			if (item != null) {
				...
				switch(Quest.type){
					case 1: default:
						msg = Messages.get(this, "reminder_dust", Dungeon.hero.heroClass.title());
						break;
					case 2:
						msg = Messages.get(this, "reminder_ember", Dungeon.hero.heroClass.title());
						break;
					case 3:
						msg = Messages.get(this, "reminder_berry", Dungeon.hero.heroClass.title());
						break;
				}
				Game.runOnRenderThread(new Callback() {
					@Override
			...
			switch(Dungeon.hero.heroClass){
				...
				case ROGUE:
					...
					break;
				case MAGE:
					msg1 += Messages.get(this, "intro_mage", Dungeon.hero.heroClass.title());
					break;
				case HUNTRESS:
					msg1 += Messages.get(this, "intro_huntress");
					break;
				case ROSECAT:
					msg1 += Messages.get(this, "intro_rosecat");
					break;
				case NEARL:
					msg1 += Messages.get(this, "intro_nearl");
					break;
				case CHEN:
					msg1 += Messages.get(this, "intro_chen");
					break;
			}

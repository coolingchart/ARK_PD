...
public class Talulah extends Mob {
            ...
            if (!Dungeon.hero.rooted) {
                ...
                for (Char ch : affected) {
                    if (Dungeon.isChallenged(Challenges.DECISIVE_BATTLE))
                        ch.damage(Random.NormalIntRange(30, 45), new Eye.DeathGaze());
                    ...
                    if (Dungeon.isChallenged(Challenges.SPECIAL_BOSS) && Dungeon.mboss9 == 1)
                        Buff.affect(ch, Paralysis.class, 20f);
            ...
            while (summonCooldown <= 0) {
                ...
                if (spawnPos != -1) {
                    ...
                    if (Dungeon.isChallenged(Challenges.SPECIAL_BOSS) && Dungeon.mboss4 == 1)
                        Buff.affect(summon, Adrenaline.class, 50f);
        ...
        if (phase < 4 && HP <= HT - 300 * phase) {
            ...
            if (phase == 2) {
                if (Dungeon.isChallenged(Challenges.SPECIAL_BOSS))
                    yell(Messages.get(this, "phase2_ch"));
                else GLog.n(Messages.get(this, "phase2"));
            } else if (phase == 3) {
                if (Dungeon.isChallenged(Challenges.SPECIAL_BOSS))
                    yell(Messages.get(this, "phase3_ch"));
    ...
    public void notice() {
        if (!BossHealthBar.isAssigned()) {
            ...
            if (Dungeon.isChallenged(Challenges.SPECIAL_BOSS))
                yell(Messages.get(this, "notice_ch"));

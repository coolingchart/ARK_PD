...
public class NewTengu extends Mob {
    ...
    private static final int MINE_ABILTY = 3;
    ...
    public boolean useAbility() {
        ...
        while (!abilityUsed) {
            ...
            if (abilityToUse != lastAbility || Random.Int(10) == 0) {
                if (MineThrow == 1) {abilityToUse = MINE_ABILTY;}
                switch (abilityToUse) {
                    case BOMB_ABILITY:
                    default:
                    ...
                    case SHOCKER_ABILITY:
                        ...
                        break;
                    case MINE_ABILTY:
                        abilityUsed = throwMine (NewTengu.this,enemy);
                        MineThrow = -1;
                        break;
                }
            }
    ...
    public static class BombAbility extends Buff {
        ...
        public static class BombItem extends Item {

            {
                ...
                image = ItemSpriteSheet.TENGU_MINE;
            }

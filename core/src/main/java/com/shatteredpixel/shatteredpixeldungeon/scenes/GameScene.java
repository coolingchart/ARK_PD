...
public class GameScene extends PixelScene {
    ...
    public void create() {
        ...
        if (Dungeon.depth == 5) {
            ...
            if (Dungeon.hero.CharSkin == Hero.MUDROCK)
                Music.INSTANCE.play(Assets.Music.BOSS3_MUDROCKSP, true);
    ...
    public static void updateplayeravater() {
        if (scene != null) scene.status.Avaterupdate();
    }

...
public class InventoryPane extends Component {
    ...
    protected void createChildren() {
        ...
        bg = Chrome.get(Chrome.Type.TOAST_TR); //TOAST_TR_HEAVY not available, using TOAST_TR
        add(bg);
        ...
        blocker = new PointerArea(0, 0, PixelScene.uiCamera.width, PixelScene.uiCamera.height){
            ...
            protected void onClick(PointerEvent event) {
                if (selector != null && !bg.overlapsScreenPoint((int)event.current.x, (int)event.current.y)){
                    ...
                    //GameScene.centerNextWndOnInvPane(); // Not available in this project
        ...
        gold = Icons.get(Icons.GOLD);
        add(gold);
        goldTxt = new BitmapText(PixelScene.pixelFont);
        goldTxt.hardlight(Window.TITLE_COLOR);
        add(goldTxt);

        // energy = Icons.get(Icons.ENERGY_SML); // Not available in this project
        // add(energy);
    ...
    public void updateInventory(){
        ...
        if (selector == null) {
            ...
            energyTxt.measure();
            energyTxt.visible = Dungeon.energy > 0;
            if (energy != null) {
                energy.visible = Dungeon.energy > 0;
            }
        } else {
    ...
    private Image bagIcon(Bag bag ) {
        if (bag instanceof VelvetPouch) {
            ...
            return Icons.get( Icons.ICE_BOX );
        } else {
    ...
    private class InventoryPaneSlot extends InventorySlot {
        ...
        // onMiddleClick() not available in this version
        ...
        // onRightClick() not available in this version
        protected void onRightClick() {
            ...
            if (selector == null){
                // RightClickMenu not available in this version
                /*
                targetingSlot = this;
    ...
    private class BagButton extends IconButton {
        ...
        // SPDAction.BAG_* and INVENTORY_SELECTOR constants not available in this version
        /*
        @Override
        ...
        */
        ...
        // hoverText() method not available in this version
        /*
        @Override
